 ...
 */
public class BaseCanvasSurfaceView extends SurfaceView implements SurfaceHolder.Callback {
  private boolean mSizeChanged = true;

  private SurfaceHolder mHolder;
  private CanvasThread mCanvasThread;
  private BaseCanvasRenderer mRenderer;
  
  public BaseCanvasSurfaceView(Context context) {
    super(context);
    init();
  }

  public BaseCanvasSurfaceView(Context context, AttributeSet attrs) {
    super(context, attrs);
    init();
  }
  ...
  public void setRenderer(Renderer renderer) {
    ...
    mCanvasThread.start();
    mRenderer = (BaseCanvasRenderer)renderer;
  }
