 ...
 *
 */
public class MSGLSurfaceView extends SurfaceView implements SurfaceHolder.Callback {
     ...
     * this interface, and then call {@link MSGLSurfaceView#setRenderer} to
     ...
     * use the {@link MSGLSurfaceView#queueEvent(Runnable)} convenience method.
     * <p>
     ...
     * {@link MSGLSurfaceView#setEGLContextFactory(EGLContextFactory)}
     */
     ...
     * <p>
     * This interface must be implemented by clients wishing to call
     * {@link MSGLSurfaceView#setEGLWindowSurfaceFactory(EGLWindowSurfaceFactory)}
     */
     ...
     * <p>
     * This interface must be implemented by clients wishing to call
     * {@link MSGLSurfaceView#setEGLConfigChooser(EGLConfigChooser)}
     */
    ...
    class GLThread extends Thread {
        ...
        private void guardedRun() throws InterruptedException {
            ...
            try {
                ...
                //Log.d("wh","guardedRun cleaning up");
                /*
                 * clean-up everything...
                 */
                synchronized (sGLThreadManager) {
