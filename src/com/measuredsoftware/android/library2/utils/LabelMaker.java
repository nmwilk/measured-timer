...
public class LabelMaker {
    ...
    public void beginAdding(GL10 gl) {
        ...
        mV = 0;
        mLineHeight = 0;
        Bitmap.Config config = Bitmap.Config.ARGB_8888;//mFullColor ? Bitmap.Config.ARGB_8888 : Bitmap.Config.ALPHA_8;
    ...
    public void endAdding(GL10 gl) {
        ...
        //FileTools.dumpBitmap(mBitmap, "/TDR/", "text.png");
     ...
     * @param labelID
     */
    public float draw(GL10 gl, float x, float y, int labelID) {
      ...
      ((GL11Ext)gl).glDrawTexfOES(snappedX, snappedY, 0, label.width, label.height);
      gl.glPopMatrix();
